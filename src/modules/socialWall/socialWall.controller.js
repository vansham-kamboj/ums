import * as service from './socialWall.service.js';
...
export const getFeed = async (req, res, next) => {
  try {
    const result = await service.getFeed(req.params, req.body, req.query, req.teamId, req.user);
...
export const addComment = async (req, res, next) => {
  try {
    const result = await service.addComment(req.params, req.body, req.query, req.teamId, req.user);
    return successResponse(res, 'Operation successful', result);
  } catch (error) { next(error); }
};
...
export const listComments = async (req, res, next) => {
  try {
    const result = await service.listComments(req.params, req.body, req.query, req.teamId, req.user);
    return successResponse(res, 'Operation successful', result);
  } catch (error) { next(error); }
};
...
export const deleteComment = async (req, res, next) => {
  try {
    const result = await service.deleteComment(req.params, req.body, req.query, req.teamId, req.user);
    return successResponse(res, 'Operation successful', result);
  } catch (error) { next(error); }
};
