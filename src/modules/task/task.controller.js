...
export const addTaskMember = async (req, res, next) => {
  try {
    const result = await service.addTaskMember(req.params, req.body, req.query, req.teamId, req.user);
...
export const removeTaskMember = async (req, res, next) => {
  try {
    const result = await service.removeTaskMember(req.params, req.body, req.query, req.teamId, req.user);
    return successResponse(res, 'Operation successful', result);
  } catch (error) { next(error); }
};
...
export const addChecklist = async (req, res, next) => {
  try {
    const result = await service.addChecklist(req.params, req.body, req.query, req.teamId, req.user);
    return successResponse(res, 'Operation successful', result);
  } catch (error) { next(error); }
};
...
export const toggleChecklist = async (req, res, next) => {
  try {
    const result = await service.toggleChecklist(req.params, req.body, req.query, req.teamId, req.user);
    return successResponse(res, 'Operation successful', result);
  } catch (error) { next(error); }
};
...
export const deleteChecklist = async (req, res, next) => {
  try {
    const result = await service.deleteChecklist(req.params, req.body, req.query, req.teamId, req.user);
    return successResponse(res, 'Operation successful', result);
  } catch (error) { next(error); }
};
