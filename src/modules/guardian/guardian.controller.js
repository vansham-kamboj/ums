...
export const linkStudent = async (req, res, next) => {
  try {
    const result = await service.linkStudent(req.params, req.body, req.query, req.teamId, req.user);
...
export const setPrimary = async (req, res, next) => {
  try {
    const result = await service.setPrimary(req.params, req.body, req.query, req.teamId, req.user);
    return successResponse(res, 'Operation successful', result);
  } catch (error) { next(error); }
};

export const importGuardians = async (req, res, next) => {
  try {
    const result = await service.importGuardians(req.params, req.body, req.query, req.teamId, req.user);
    return successResponse(res, 'Operation successful', result);
  } catch (error) { next(error); }
};

export const createGuardianAccount = async (req, res, next) => {
  try {
    const result = await service.createGuardianAccount(req.params, req.body, req.query, req.teamId, req.user);
    return successResponse(res, 'Operation successful', result);
  } catch (error) { next(error); }
};

export const syncGuardian = async (req, res, next) => {
  try {
    const result = await service.syncGuardian(req.params, req.body, req.query, req.teamId, req.user);
    return successResponse(res, 'Operation successful', result);
  } catch (error) { next(error); }
};

export const exportGuardians = async (req, res, next) => {
  try {
    const result = await service.exportGuardians(req.params, req.body, req.query, req.teamId, req.user);
    return successResponse(res, 'Operation successful', result);
  } catch (error) { next(error); }
};
