...
export const addGalleryImage = async (req, res, next) => {
  try {
    const result = await service.addGalleryImage(req.params, req.body, req.query, req.teamId, req.user);
...
export const deleteGalleryImage = async (req, res, next) => {
  try {
    const result = await service.deleteGalleryImage(req.params, req.body, req.query, req.teamId, req.user);
    return successResponse(res, 'Operation successful', result);
  } catch (error) { next(error); }
};

export const listPublicGalleries = async (req, res, next) => {
  try {
    const result = await service.listPublicGalleries(req.params, req.body, req.query, req.teamId, req.user);
    return successResponse(res, 'Operation successful', result);
  } catch (error) { next(error); }
};
...
export const getPublicGallery = async (req, res, next) => {
  try {
    const result = await service.getPublicGallery(req.params, req.body, req.query, req.teamId, req.user);
    return successResponse(res, 'Operation successful', result);
  } catch (error) { next(error); }
};
