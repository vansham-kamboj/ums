...
export const addApprovalLevel = async (req, res, next) => {
  try {
    const result = await service.addApprovalLevel(req.params, req.body, req.query, req.teamId, req.user);
...
export const submitApprovalRequest = async (req, res, next) => {
  try {
    const result = await service.submitApprovalRequest(req.params, req.body, req.query, req.teamId, req.user);
    return successResponse(res, 'Operation successful', result);
  } catch (error) { next(error); }
};
...
export const approveRequest = async (req, res, next) => {
  try {
    const result = await service.approveRequest(req.params, req.body, req.query, req.teamId, req.user);
    return successResponse(res, 'Operation successful', result);
  } catch (error) { next(error); }
};
...
export const rejectRequest = async (req, res, next) => {
  try {
    const result = await service.rejectRequest(req.params, req.body, req.query, req.teamId, req.user);
    return successResponse(res, 'Operation successful', result);
  } catch (error) { next(error); }
};
