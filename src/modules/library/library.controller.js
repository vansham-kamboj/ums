...
export const addBookCopy = async (req, res, next) => {
  try {
    const result = await service.addBookCopy(req.params, req.body, req.query, req.teamId, req.user);
    return successResponse(res, 'Operation successful', result);
  } catch (error) { next(error); }
};

export const addBookAddition = async (req, res, next) => {
  try {
    const result = await service.addBookAddition(req.params, req.body, req.query, req.teamId, req.user);
    return successResponse(res, 'Operation successful', result);
  } catch (error) { next(error); }
};
...
export const issueBook = async (req, res, next) => {
  try {
    const result = await service.issueBook(req.params, req.body, req.query, req.teamId, req.user);
    return successResponse(res, 'Operation successful', result);
  } catch (error) { next(error); }
};
...
export const returnBook = async (req, res, next) => {
  try {
    const result = await service.returnBook(req.params, req.body, req.query, req.teamId, req.user);
    return successResponse(res, 'Operation successful', result);
  } catch (error) { next(error); }
};
...
export const getOverdueBooks = async (req, res, next) => {
  try {
    const result = await service.getOverdueBooks(req.params, req.body, req.query, req.teamId, req.user);
    return successResponse(res, 'Operation successful', result);
  } catch (error) { next(error); }
};

export const getLibraryReports = async (req, res, next) => {
  try {
    const result = await service.getLibraryReports(req.params, req.body, req.query, req.teamId, req.user);
    return successResponse(res, 'Operation successful', result);
  } catch (error) { next(error); }
};
