...
export const listMessages = async (req, res, next) => {
  try {
    const result = await service.listMessages(req.params, req.body, req.query, req.teamId, req.user);
...
export const sendMessage = async (req, res, next) => {
  try {
    const result = await service.sendMessage(req.params, req.body, req.query, req.teamId, req.user);
    return successResponse(res, 'Operation successful', result);
  } catch (error) { next(error); }
};
...
export const markMessageRead = async (req, res, next) => {
  try {
    const result = await service.markMessageRead(req.params, req.body, req.query, req.teamId, req.user);
    return successResponse(res, 'Operation successful', result);
  } catch (error) { next(error); }
};
...
export const searchChatUsers = async (req, res, next) => {
  try {
    const result = await service.searchChatUsers(req.params, req.body, req.query, req.teamId, req.user);
    return successResponse(res, 'Operation successful', result);
  } catch (error) { next(error); }
};
