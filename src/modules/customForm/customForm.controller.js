import * as service from './customForm.service.js';
...
export const addFormField = async (req, res, next) => {
  try {
    const result = await service.addFormField(req.params, req.body, req.query, req.teamId, req.user);
...
export const updateFormField = async (req, res, next) => {
  try {
    const result = await service.updateFormField(req.params, req.body, req.query, req.teamId, req.user);
    return successResponse(res, 'Operation successful', result);
  } catch (error) { next(error); }
};
...
export const deleteFormField = async (req, res, next) => {
  try {
    const result = await service.deleteFormField(req.params, req.body, req.query, req.teamId, req.user);
    return successResponse(res, 'Operation successful', result);
  } catch (error) { next(error); }
};
...
export const submitForm = async (req, res, next) => {
  try {
    const result = await service.submitForm(req.params, req.body, req.query, req.teamId, req.user);
    return successResponse(res, 'Operation successful', result);
  } catch (error) { next(error); }
};
...
export const listSubmissions = async (req, res, next) => {
  try {
    const result = await service.listSubmissions(req.params, req.body, req.query, req.teamId, req.user);
    return successResponse(res, 'Operation successful', result);
  } catch (error) { next(error); }
};
