...
export const initiatePayment = async (req, res, next) => {
  try {
    const result = await service.initiatePayment(req.params, req.body, req.query, req.teamId, req.user);
...
export const verifyPayment = async (req, res, next) => {
  try {
    const result = await service.verifyPayment(req.params, req.body, req.query, req.teamId, req.user);
    return successResponse(res, 'Operation successful', result);
  } catch (error) { next(error); }
};
...
export const getPaymentStatus = async (req, res, next) => {
  try {
    const result = await service.getPaymentStatus(req.params, req.body, req.query, req.teamId, req.user);
    return successResponse(res, 'Operation successful', result);
  } catch (error) { next(error); }
};

export const listActiveGateways = async (req, res, next) => {
  try {
    const result = await service.listActiveGateways(req.params, req.body, req.query, req.teamId, req.user);
    return successResponse(res, 'Operation successful', result);
  } catch (error) { next(error); }
};

export const guestPayment = async (req, res, next) => {
  try {
    const result = await service.guestPayment(req.params, req.body, req.query, req.teamId, req.user);
    return successResponse(res, 'Operation successful', result);
  } catch (error) { next(error); }
};
...
export const handleWebhook = async (req, res, next) => {
  try {
    const result = await service.handleWebhook(req.params, req.body, req.query, req.teamId, req.user);
    return successResponse(res, 'Operation successful', result);
  } catch (error) { next(error); }
};
